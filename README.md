...
Metodología
Carga, limpieza y exploración de los 4 datasets de la prueba (participantes, eventos, calendario de marketing).
Validación del diseño experimental: verificación de tamaño de muestra, balance entre grupos, segmentación geográfica y estructura del embudo.
Prueba de hipótesis: prueba z de proporciones por etapa del embudo, con corrección de Bonferroni para comparaciones múltiples.
Análisis complementario: comparación de actividad por usuario (prueba de Mann-Whitney U) y análisis de patrones temporales.
Visualizaciones: embudo comparativo y gráficos de conversión con significancia estadística marcada.
Herramientas
